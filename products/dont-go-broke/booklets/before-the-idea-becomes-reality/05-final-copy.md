...
This booklet is a tool to protect your idea from premature execution. It is the first stage in the *Don’t Go Broke* series because it focuses on the earliest, most preventable mistake a first-time builder can make: **turning an unclear idea into a real project too soon.**
...
A few years ago, an unclear app idea stayed unclear for a while. You might talk about it or sketch it, but there was friction between the idea and the build. 
...
```text
I know what I am excited about.
But I do not yet know what the project is.
```
...
## 2. Why AI Makes Ideas Feel Ready Too Soon
...
AI is excellent at making vague ideas concrete. This helps when you are exploring, but it can trick you into believing the idea is ready just because something visible exists. Once you see it, emotional pressure kicks in. You start reacting to the output: “Add login.” “Make it mobile.” “Add notifications.” 
...
```text
What would make this idea worth building if AI had not already generated 
anything?
```
...
## 3. The Difference Between an Idea and a Project
...
## 4. What Problem Does This Actually Solve?
...
```text
This idea helps __________ do, avoid, decide, understand, or manage __________ 
because __________.
```
...
## 5. Who Is Version One Actually For?
...
Not a perfect persona or a market segment. Just a clear answer to:

```text
Who needs the first useful version of this?
```

If your answer is “everyone,” version one has no anchor. Different people need different things, and those different expectations create conflicting screens, settings, and workflows. That is how a small idea becomes bloated before it becomes clear. 
...
```text
The first version is for __________, who needs help with __________.
```
...
## 7. What Is Explicitly Not Included Yet?
...
```text
For version one, we are not building __________, __________, or __________ yet.
```
...
## 8. What Would Make This Project Too Expensive, Too Vague, or Too Large?
...
```text
This project is not ready if __________.
```
...
**Stop Sign 1: You cannot explain the problem simply**
If you need a long explanation before someone understands the problem, the project is too vague. If you cannot fill in "The problem is: __________" cleanly, pause.

**Stop Sign 2: You cannot name the first user**
If version one is for “everyone,” it will probably become too large. If you cannot name the first person who needs this, pause.

**Stop Sign 3: Version one has too many jobs**
A first version should not solve five problems at once. If it needs to manage, recommend, schedule, analyze, and sell, it is too large. 

**Stop Sign 4: You cannot say what is not included yet**
If nothing can be excluded, the project has no boundary. 

**Stop Sign 5: The project depends on features you do not understand**
You do not need to be a professional developer. But if version one depends on things you cannot explain, review, or recognize when broken, the project may be too risky. Version one may need to be smaller.

**Stop Sign 6: You cannot review whether AI built the right thing**
If AI gives you output and you would not know whether it matches the intended project, pause. If the project is too vague to review, it is too vague to build.

**Stop Sign 7: You cannot explain what “done” means**
A project needs an end point for version one. If you cannot say what counts as a usable first version, AI may keep building past the point where you understand the project. 

A stop sign means the idea needs more clarity before it becomes real.

---

## 9. Ready, Pause, or Do Not Start Yet

You do not need certainty. You just need enough clarity to move forward with your eyes open. 

At this stage, there are three useful decisions: Ready, Pause, or Do Not Start Yet. All three can be good decisions.
...
### Do Not Start Yet
Do not start yet may be the right decision if the idea is too vague, too large, too expensive, or too dependent on assumptions to become a project right now. 

That can be frustrating, but it can also save you from spending time and money on a project you cannot yet control. It means this idea has not earned project status yet. It can stay an idea while you keep notes, simplify it, or choose to build it later. 

Before you move forward, make the call:

```text
My decision is: Ready / Pause / Do Not Start Yet
...
## 10. Bridge to the Next Booklet: Before the Build Starts
...
That is enough to cross the first gate. But it is not yet enough to hand the project to AI and let it build. 

This booklet helped you decide what the project is allowed to become. The next job is to design the project before AI begins building. That is where *Before the Build Starts* comes in.

The next booklet deals with the blueprint stage: what screens may be needed, what user flows may be needed, what data may be involved, what constraints matter, and what kind of handoff protects the project. 
...
You are not ready to build because you are excited. 
...
Use this page before asking AI to build the app.
...
Use this page to protect version one.

A “not yet” feature is not rejected forever.

It is excluded from version one so the first project stays clear and controllable.
...
If your decision is Ready, continue to:

```text
Before the Build Starts
```

Bring these answers with you. The next step is not to let AI build freely. The next step is to design the project before the build starts.
